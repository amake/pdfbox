...
public abstract class PDCIDFont implements COSObjectable, PDFontLike, PDVectorFont
{
    ...
    protected final Map<Integer, Float> verticalDisplacementY = new HashMap<>(); // w1y
    protected final Map<Integer, Vector> positionVectors = new HashMap<>();     // v
    protected float[] dw2 = new float[] { 880, -1000 };
